...
final class Variable2 extends PrologObject//Serializable
{
    ...
    public Variable2(final String strName)
    {
        m_strName = strName;
        m_nTimestamp = counter++;
    }

    public Variable2(final boolean bAnonymous)
    {
    	m_nTimestamp = counter++;
    ...
    public final PrologObject getObject()
    {
        ...
        while(object instanceof Variable2)
        {
            object = ((Variable2)object).m_object;
        }

        return object;
    }

    public final Variable2 lastVariable()
    {
//    	System.out.println("lastVariable");
        Variable2 var = this;
        PrologObject obj = m_object;
        while(obj instanceof Variable2)
        {
//        	System.out.println(((Variable)obj).getName() + " " + ((Variable)obj).hashCode());
            var = (Variable2)obj;
            obj = ((Variable2)obj).m_object;
        }
...
//    	return m_nTimestamp;//lastVariable().hashCode();//m_address;//m_nAddress;
    ...
    public final PrologObject copy(final boolean flat, final Hashtable<Variable2, PrologObject> varTable)
    {
        final Variable2 var = lastVariable();
        ...
        else
        {
            ...
            if(var.m_object != null)
            {
            	...
            	else
            	{
                    ...
                    final Variable2 newVar = new Variable2(m_strName);
    ...
    public final boolean _unify(final PrologObject obj, Hashtable<Variable2, Variable2> varTbl)
    {
//        System.out.println("*** Variable unify: " + this + " - " + obj);
        ...
        else // unbounded
        {
            ...
            else
            {
                ...
                {
                    Variable2 objVar = ((Variable2)obj).lastVariable();
...
//                	
                	return timestamp() < ((Variable2)obj).timestamp();
...
//                	return getName().compareTo(((Variable)obj).getName()) < 0;
    ...
    public boolean termEquals(PrologObject obj)
    {
    	...
    	else if(obj instanceof Variable2)
        {
    		if (((Variable2)obj).isBounded())
    			return false;
    		else
    			return lastVariable().getName().compareTo(((Variable2)obj).lastVariable().getName()) == 0;//lastVariable().getAddress() == ((Variable)obj).lastVariable().getAddress();
