...
//                                      || ((term instanceof ConsCell) && m_nTokCount == 2))
                                //if(!(term instanceof ConsCell) || term  instanceof List || term  instanceof Functor || term  instanceof Clause)
                                {
                                    // atomo
...
//                                                        System.out.println("remainder " + lastObj);
                                        ...
                                        else //if(lastObj instanceof Operator)
                                        {
                                            if(termStack.size() == 1)
                                            {
                                                // lastop può essere solo prefix altrimenti sarebbe stato
                                                // già trasformato in atomo
                                                termStack.push(curOp);
                                                lastObj = null;
                                            }
